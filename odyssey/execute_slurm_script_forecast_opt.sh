...
do
    ...
    do
        sbatch --output=output_opt_${pred}_${var}.out --error=error_opt_${pred}_${var}.err --job-name=cl_opt_$pred main_odyssey_forecast_opt.sh ${pred} ${var} 0 1980 standardized-opt
    done
done
