...
#SBATCH --mem=10Gb  # Memory request (16Gb)
...
python3 ../main_cluster_forecast_nn_talos.py -ini ../ini/clusters_America_${pred}_Forecast_opt_${prec}_NN.ini --outputlabel $outputlabel --predictand $pred --logfile logs/log_${pred}_${prec}.log --datarange $datamin $datamax --forecast_precursors ${prec}
