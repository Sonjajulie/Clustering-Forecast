...
#~ foreach var ($arr) 
    ...
    #~ foreach i (`seq 1 1 35`)
        ...
        #~ if ($i == 1) then
            ...
            #~ set outputfile = /home/sonja/Documents/Composites/input_cluster/input_cluster_anom_$var_small/$var_small.final.$pad_i.192001-199012.nc
            #~ cdo detrend $inputfile detrend.nc
            #~ cdo timmean $inputfile timmean.nc
            #~ cdo add detrend.nc timmean.nc out1.nc
            #~ cdo selyear,1921/1990 out1.nc $outputfile
...
#~ foreach var ($arr) 
    ...
    #~ foreach i (`seq 1 1 35`)
        ...
        #~ if ($i == 1) then
            ...
            #~ cdo selyear,1920/1989 deterend_timmean.nc $outputfile
